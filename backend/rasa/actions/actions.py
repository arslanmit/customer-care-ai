...
# Define database path using os.path.join for cross-platform compatibility
# Path is relative from actions.py, going up one directory to the backend/rasa folder
# then up one more to the backend folder, then up one more to the root, then to the db folder
DB_PATH = os.path.abspath(os.path.join(os.path.dirname(__file__), '../../../db/AdventureWorks.db'))
